...
/** @returns {LevelBlock} */
function createReplaceSpanBlock(clickable, replacement, event) {
    return {
...
/** @returns {LevelBlock} */
function createReplaceBlock(text, replacement, event, clickable = null) {
    return {
...
/** @returns {LevelBlock} */
function createReplaceOnBlock(text, replacement, event) {
    return {
...
describe('applyEvents', () => {
    ...
    test('should handle complex scenario with multiple events', () => {
        const blocks = [createTextBlock('# Example code'), createReplaceBlock('def getData():\n    return "data"', 'def get_user_data():\n    # return data\n    return "data"', 'rename-func1'), createTextBlock("print(getData())"), createReplaceSpanBlock('getData', 'get_user_data', 'rename-func2'), createReplaceOnBlock('result = getData()', 'result = get_user_data()', 'rename-func1'), createReplaceOnBlock('if getData():', 'if get_user_data():', 'rename-func2')];
...
`)
        ...
        expected.forEach((expected) => {
            const found = result.regions.some(actual => expected.startLine === actual.startLine && expected.endLine === actual.endLine && expected.startCol === actual.startCol && expected.endCol === actual.endCol);
