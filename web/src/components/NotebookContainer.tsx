 ...
 */
export function NotebookContainer(): React.ReactElement | null {
    const context = useContext(GameStateContext);

    if (!context) {
        throw new Error('NotebookContainer must be used within a GameStateContext Provider');
    }
    ...
    const getWisdomEntries = (): WisdomEntry[] => {
    ...
    return createPortal(
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-end z-50">
            <div
                className="bg-[#252526] w-full max-w-md h-full overflow-y-auto shadow-lg transform transition-transform duration-300">
                <div
                    className="sticky top-0 bg-[#252526] p-4 border-b border-[#3c3c3c] flex justify-between items-center">
